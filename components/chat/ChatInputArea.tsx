    ...
    return (
        <div className="sticky bottom-0 z-20 pb-[env(safe-area-inset-bottom,1.5rem)] px-2 sm:px-4">
            <div className="mx-auto w-full max-w-4xl relative">
                ...
                <div 
                    className={`border transition duration-200 relative overflow-hidden rounded-2xl ${isDragging ? 'border-dashed border-emerald-500 bg-emerald-50 dark:bg-emerald-500/10 ring-2 ring-emerald-500/50 scale-[1.01]' : 'border-gray-200 dark:border-white/10 bg-white dark:bg-zinc-900 shadow-sm'} ${isLoading ? 'ring-1 ring-emerald-500/50' : 'focus-within:ring-1 focus-within:ring-emerald-500 focus-within:border-emerald-500'}`}
