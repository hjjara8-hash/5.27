    ...
    const footerButtons = (
        <>
            <Button 
                ...
                className="mr-auto border border-white/10"
                title="Download the exact transcript context used by Shadow Mode"
                icon={<ArrowDownTrayIcon className="w-4 h-4 text-emerald-400" />}
            >
                Download Transcript
            </Button>
                ...
                <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="text-xs text-gray-400 mb-1 flex items-center">
                                    <UserIcon className="w-3 h-3 mr-1 text-emerald-400"/> {t.shadowTranscriptUserName}
                                </label>
                                <Input 
                                    type="text" 
                    ...
                    <div className="bg-black/20 p-3 rounded border border-white/10">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <Button variant="ghost" size="sm" onClick={() => openEdit('persona')} className="text-xs text-emerald-300 hover:text-emerald-200 bg-emerald-500/10 px-2 py-1 border border-emerald-500/20 h-auto" icon={<PencilIcon className="w-3 h-3"/>}>Edit</Button>
                        </div>
                        <div 
                    ...
                    <div className="bg-black/20 p-3 rounded border border-white/10">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <Button variant="ghost" size="sm" onClick={() => openEdit('task')} className="text-xs text-emerald-300 hover:text-emerald-200 bg-emerald-500/10 px-2 py-1 border border-emerald-500/20 h-auto" icon={<PencilIcon className="w-3 h-3"/>}>Edit</Button>
                        </div>
                        <div 
