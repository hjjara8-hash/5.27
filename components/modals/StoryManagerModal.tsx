        ...
        <div className="relative p-3 mb-3 rounded-md bg-black/20 border border-white/10 flex flex-col gap-2 group transition hover:bg-white/5">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1">
                    <Button variant="ghost" onClick={() => onMove(index, 'up')} disabled={isFirst} className="p-1 text-gray-500 hover:text-white">▲</Button>
                    <Button variant="ghost" onClick={() => onMove(index, 'down')} disabled={isLast} className="p-1 text-gray-500 hover:text-white">▼</Button>
                    <Button variant="ghost" onClick={() => onEdit(index)} className="p-1.5 ml-2 hover:text-indigo-300 bg-white/5" title="Edit"><PencilIcon className="w-3.5 h-3.5" /></Button>
                    <Button variant="ghost" onClick={() => onDelete(index)} className="p-1.5 ml-1 hover:text-red-400 bg-white/5" title="Delete"><TrashIcon className="w-3.5 h-3.5" /></Button>
                </div>
            </div>
    ...
    return (
        <div className="space-y-4 p-1">
            ...
            <div className="flex justify-end gap-2 pt-2">
                ...
                <Button variant="primary" size="sm" onClick={handleSave} className="bg-indigo-600 hover:bg-indigo-500">Save</Button>
            </div>
        </div>
    );
});
            ...
            <div className="space-y-4">
                ...
                <div className="flex justify-between items-center mb-2">
                    ...
                    <Button 
                        ...
                        className="text-indigo-300 bg-indigo-500/10 hover:bg-indigo-500/20"
