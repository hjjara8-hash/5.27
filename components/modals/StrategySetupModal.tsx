...
const StrategySetupModal: React.FC = memo(() => {
    ...
    const footerButtons = (
        <>
            <Button variant="secondary" onClick={closeStrategySetupModal}>{t.cancel}</Button>
            ...
            <div className="space-y-5">
                ...
                <div className={isEnabled ? '' : 'opacity-50 pointer-events-none'}>
                    ...
                    <Textarea
                        ...
                        className="h-64 resize-y font-mono border-amber-500/30 focus:border-amber-500 focus:ring-amber-500/50"
                ...
                <div className={isEnabled ? '' : 'opacity-50 pointer-events-none'}>
                    ...
                    <Textarea
                        ...
                        className="h-20 resize-y font-mono border-amber-500/30 focus:border-amber-500 focus:ring-amber-500/50"
